...
class TestPermissionDenied:
    def test_list(self, inactive_user, api_client, monkeypatch):
    ...
    def test_retrieve(self, inactive_user, active_user, api_client, monkeypatch):
    ...
    def test_patch(self, inactive_user, active_user, api_client, monkeypatch):
    ...
    def test_delete(self, inactive_user, active_user, api_client, monkeypatch):
        url = parse_url(BASENAME, "detail", active_user.id)
    ...
    def test_related_objects(self, url_name, inactive_user, active_user, api_client, monkeypatch):
        url = parse_url(BASENAME, url_name, active_user.id)
