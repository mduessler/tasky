...
class TestPagination:
    def test_first_page(self, superuser, users, api_client, monkeypatch):
    ...
    def test_n_page(self, superuser, users, api_client, monkeypatch):
        url = parse_url(BASENAME, "list")
    ...
    def test_last_page(self, superuser, users, api_client, monkeypatch):
        url = parse_url(BASENAME, "list")
    ...
    def test_tasks_pagination(self, superuser, active_user, tasks, api_client, monkeypatch):
    ...
    def test_task_memberships_pagination(
        self, superuser, active_user, task_memberships, api_client, monkeypatch
    ):
    ...
    def test_task_notes_pagination(
        self, superuser, active_user, task_notes, api_client, monkeypatch
    ):
