...
class TestPagination:
    def test_first_page(self, superuser, task_memberships, api_client, monkeypatch):
    ...
    def test_n_page(self, superuser, task_memberships, api_client, monkeypatch):
        url = parse_url(BASENAME, "list")
    ...
    def test_last_page(self, superuser, task_memberships, api_client, monkeypatch):
        url = parse_url(BASENAME, "list")
